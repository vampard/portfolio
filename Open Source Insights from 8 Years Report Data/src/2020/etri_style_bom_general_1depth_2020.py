...
# used for 2020 : NIPA Army, NIPA Company, NIPA HD Third Party, NIPA Support
...
def file_search(dirlists, work_dir):
	...
	for i in trange(0,len(dirlists)):
		...
		if len(work_path) != 0:
			...
			temp_df = pd.read_excel(work_path, sheet_name='3. 준법성 현황', skiprows=[0], encoding="cp949")
...
if __name__ == "__main__":
	...
	target_dir = "\\data\\2020\\NIPA_Support"
