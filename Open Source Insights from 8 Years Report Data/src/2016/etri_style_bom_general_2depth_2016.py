...
# used for 2016 : Sales report, 알티캐스트, NIPA GCS, NIPA Company, NIPA Individual, NIPA University
		...
		if os.path.exists(work_path):
			...
			if len(work_files) != 0:
				...
				for j in range(0, len(work_files)):
					...
					print(work_path2)
					temp_df = pd.read_excel(work_path2, sheet_name='프로젝트 구성요소 목록(Bill of Materials)', skiprows=[0], encoding="cp949")
...
if __name__ == "__main__":
	...
	target_dir = "\\data\\2016\\Audit_Service\\알티캐스트"
